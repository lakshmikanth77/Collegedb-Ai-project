...
def get_answer(question):
    ...
    functions = [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    "student_name": {
                        "type": "string",
                        "description": "Name of the student. e.g John",
                    },
                    "semester": {
                        "type": "integer",
    ...
    if response_message.get("function_call"):
        available_functions = {
            "get_marks": db_helper1.get_marks,
            "get_fees": db_helper1.get_fees
        }
...
if __name__ == '__main__':
    ...
    print(get_answer("how much was peter's due fees in the first semester?"))